...
class Exercise_Chapter10_11 : public D3DApp
{
public:
	Exercise_Chapter10_11(HINSTANCE hInstance);
	~Exercise_Chapter10_11();
	...
	PSTR cmdLine, int showCmd)
{
	...
	Exercise_Chapter10_11 theApp(hInstance);
...
Exercise_Chapter10_11::Exercise_Chapter10_11(HINSTANCE hInstance)
...
Exercise_Chapter10_11::~Exercise_Chapter10_11()
{
...
bool Exercise_Chapter10_11::Init()
{
	if (!D3DApp::Init())
		return false;
...
void Exercise_Chapter10_11::OnResize()
{
	D3DApp::OnResize();
...
void Exercise_Chapter10_11::UpdateScene(float dt)
{
...
void Exercise_Chapter10_11::DrawScene()
{
...
void Exercise_Chapter10_11::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Exercise_Chapter10_11::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void Exercise_Chapter10_11::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void Exercise_Chapter10_11::BuildRoomGeometryBuffers()
{
	Vertex::Basic32 v[30];
...
void Exercise_Chapter10_11::BuildSkullGeometryBuffers()
{
