	...
	: Effect(device, filename)
{
	...
	SamplerState		= mFX->GetVariableByName("gSamplerState")->AsSampler();
}
...
void Effects::InitTreeFX(ID3D11Device* device, std::wstring filename)
{
	TreeSpriteFX = new TreeSpriteEffect(device, TEXT("../FX/") +filename);
}
