...
class Exercise_Chapter10_9 : public D3DApp
{
public:
	Exercise_Chapter10_9(HINSTANCE hInstance);
	~Exercise_Chapter10_9();
...
{
	Exercise_Chapter10_9 theApp(hInstance);
...
Exercise_Chapter10_9::Exercise_Chapter10_9(HINSTANCE hInstance)
	...
	mTheta(1.3f * MathHelper::Pi), mPhi(0.4f * MathHelper::Pi), mRadius(80.0f)
{
	...
	mDepthMat.Ambient = XMFLOAT4(0.05f, 0.05f, 0.05f, 1.0f);
	mDepthMat.Diffuse = XMFLOAT4(0.05f, 0.05f, 0.05f, 1.0f);
	mDepthMat.Specular = XMFLOAT4(0.05f, 0.05f, 0.05f, 1.0f);


}

Exercise_Chapter10_9::~Exercise_Chapter10_9()
{
...
bool Exercise_Chapter10_9::Init()
{
	if (!D3DApp::Init())
		return false;
...
void Exercise_Chapter10_9::OnResize()
{
	D3DApp::OnResize();
...
void Exercise_Chapter10_9::UpdateScene(float dt)
{
...
void Exercise_Chapter10_9::DrawScene()
{
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		Effects::BasicFX->SetMaterial(mDepthMat);
...
void Exercise_Chapter10_9::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Exercise_Chapter10_9::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void Exercise_Chapter10_9::OnMouseMove(WPARAM btnState, int x, int y)
{
...
float Exercise_Chapter10_9::GetHillHeight(float x, float z)const
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 Exercise_Chapter10_9::GetHillNormal(float x, float z)const
{
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
...
void Exercise_Chapter10_9::BuildLandGeometryBuffers()
{
...
void Exercise_Chapter10_9::BuildWaveGeometryBuffers()
{
...
void Exercise_Chapter10_9::BuildCrateGeometryBuffers()
{
