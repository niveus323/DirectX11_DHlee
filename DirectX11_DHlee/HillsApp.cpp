...
{
	mMainWndCaption = TEXT("Hills Demo");
...
void HillsApp::BuildGeometryBuffers()
{
	...
	//x방향 n등분, z방향 m등분한 Width x Depth 사이즈 그리드를 형성한다.
	geoGen.CreateGrid(1000.0f, 500.0f, 1000, 1000, grid);

	mGridIndexCount = grid.Indices.size();

	//형성한 그리드의 각 좌표를 순환하며 높이 y를 계산하여 Vertex 정보에 갱신.
